...
export interface ApiArticalPageArticalPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Featured_Article_Title: Schema.Attribute.String;
...
export interface ApiCategoryCategory extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
    posts: Schema.Attribute.Relation<'oneToMany', 'api::posts.posts'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiContactRequestsContactRequests
  ...
  info: {
    ...
    pluralName: 'contact-requests-requests';
    singularName: 'contact-requests';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiContactUsPageContactUsPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    Banner_Section: Schema.Attribute.Component<'shared.hero-section', false>;
...
export interface ApiGlobalGlobal extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    Footer_Section: Schema.Attribute.Component<'shared.footer-section', false>;
    Header_Section: Schema.Attribute.Component<'shared.header-section', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::global.global'
    ...
    Site_Description: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiPostsPosts extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    Featured_Video: Schema.Attribute.Media<'files' | 'videos'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
